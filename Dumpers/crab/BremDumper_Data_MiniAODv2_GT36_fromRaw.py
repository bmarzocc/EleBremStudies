...
# with command line options: RECO --conditions 106X_dataRun2_v36 --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2018,Configuration/DataProcessing/Utils.addMonitoring --datatier AOD,MINIAOD --era Run2_2018,pf_badHcalMitigation --eventcontent AOD,MINIAOD --filein _placeholder_.root --fileout file:ReReco-Run2018D-EGamma-15Feb2022_UL2018-00001.root --nThreads 8 --no_exec --python_filename ReReco-Run2018D-EGamma-15Feb2022_UL2018-00001_0_cfg.py --scenario pp --step RAW2DIGI,L1Reco,RECO,EI,PAT --runUnscheduled --data
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run2_2018_cff import Run2_2018
from Configuration.Eras.Modifier_pf_badHcalMitigation_cff import pf_badHcalMitigation

process = cms.Process('RERECO',Run2_2018,pf_badHcalMitigation)
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:outputAOD.root'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:outputMINIAOD.root'),
